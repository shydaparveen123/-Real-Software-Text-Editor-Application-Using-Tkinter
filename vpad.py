...
main_application.title('vpad tex editor')
...
font_box.grid(row=0, column=0, padx=55)
...
def hide_toolbar():
    ...
    if show_toolbar:
        ...
        tool_bar.pack(side=tk.TOP, file=tk.X)
        text_editor.pack(fill=tk.Both, expand=True)
        status_bar.pack(side=tk.BOTTOM)
        show_toolbar = True
